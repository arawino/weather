...
<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
            <h1>{{ $data->getCity() }} Weather Forecast</h1>
        </div>

        <div class="mt-8 bg-white font-size: 17px; margin-right: 15px; dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg border-gray-200 dark:border-gray-700 md:border-l" style="padding: 20px">
